...
def cli(
    ...
    if build_all and rebuild:
        raise click.UsageError("--build-all and --rebuild cannot be used together.")
    ...
    if rebuild and stage is not None:
        raise click.UsageError("--rebuild cannot be combined with --stage.")
